"""
query_known_bh_simbad_v3.py - Query Simbad (fixed column names)
=======================================================================
Fix: use LOWERCASE column names: 'main_id', 'otype', 'ra', 'dec'
...
def query_known_bh_simbad_v3():
    ...
    # Save updated data
    output_path = Path(__file__).parent.parent / "data" / "known_bh_xray_binaries_simbad_v3.json"
