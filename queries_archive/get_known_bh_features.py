"""
get_known_bh_features.py - Get IR colors + PM for known black holes
====================================================================================
Cross-match known BH X-ray binaries with 2MASS, WISE, Gaia to get features.

Features to get:
  - IR colors: J-H, H-K, W1-W2, W2-W3
  - Proper motion: pm_ra, pm_dec, pm_total (from Gaia)
  - Optional: variability (from ZTF/ATLAS)
...
def get_known_bh_features():
    ...
    for i, bh in enumerate(data["black_holes"]):
        name = bh["simbad_main_id"]
        ra = bh["simbad_ra_deg"]
        dec = bh["simbad_dec_deg"]
    ...
    # Save updated data
    output_path = Path(__file__).parent.parent / "data" / "known_bh_xray_binaries_features.json"
